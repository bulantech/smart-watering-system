...
void sendSensor()
{
  Blynk.virtualWrite(V0, sensorData[0]);
  Blynk.virtualWrite(V1, sensorData[1]);
  Blynk.virtualWrite(V2, sensorData[2]);
  Blynk.virtualWrite(V3, sensorData[3]);
}
